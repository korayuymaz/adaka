              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    ADAKA Adana Kağıt San. Tic. A.Ş.Tarsus Organize Sanayi BölgesiSağlıklı Mah. 2. Cadde No:8 Tarsus OSBMersin/Türkiye
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="font-bold text-lg mb-2">{t('phone')}</h3>
                  <p className="text-gray-700">
                    <a href="tel:+905551234567" className="hover:text-red-600 transition-colors">+90 324 651 53 53
                    </a>
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    <a href="mailto:info@adaka.com.tr" className="hover:text-red-600 transition-colors">
                      info@adaka.com.tr
                    </a>
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="font-bold text-lg mb-2">{t('businessHours')}</h3>
                  <p className="text-gray-700">
                    {t('mondayFriday')}<br />
                    {t('saturday')}<br />
                    {t('sunday')}
